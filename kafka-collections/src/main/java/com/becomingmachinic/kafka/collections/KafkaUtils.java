...
public class KafkaUtils {
	...
	public static void checkConnectivity(CollectionConfig collectionConfig) throws KafkaCollectionException {
		try (KafkaConsumer<String, String> consumer = new KafkaConsumer<String, String>(collectionConfig.getConsumerConfig(new StringDeserializer(), new StringDeserializer()))) {
